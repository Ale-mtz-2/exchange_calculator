...
DROP INDEX IF EXISTS nutrition.idx_unique_name;
DROP INDEX IF EXISTS idx_unique_name;

CREATE UNIQUE INDEX IF NOT EXISTS uq_foods_name_group_category
  ON nutrition.foods (name, exchange_group_id, category_id);
