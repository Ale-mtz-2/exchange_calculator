/*
  ...
  - A unique constraint covering the columns `[food_id,data_source_id,state]` on the table `food_nutrition_values` will be added. If there are existing duplicate values, this will fail.
...
-- DropTable
DROP TABLE "equivalentes_app"."leads";
