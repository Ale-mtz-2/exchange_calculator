...
export const panelCardClass =
  'rounded-2xl border border-sky/15 bg-gradient-to-br from-white/95 via-white/90 to-sky-50/55 p-4 shadow-[0_10px_24px_rgba(24,47,80,0.07)]';

export const tinyHelpTextClass = 'text-xs text-slate-500';

export const fieldErrorClass = 'text-xs font-semibold text-red-600';

export const textAreaClass = `${inputClass} min-h-[92px] resize-y`;
